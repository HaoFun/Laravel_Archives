...
UE.I18N['zh-cn'] = {
    'labelMap':{
        ...
        'superscript':'上標', 'formatmatch':'格式刷', 'source':'原代碼', 'blockquote':'引用',
        ...
        'fontfamily':'字體', 'fontsize':'字體大小', 'paragraph':'段落格式', 'simpleupload':'單圖上傳', 'insertimage':'上傳圖片','edittable':'表格屬性','edittd':'單元格屬性', 'link':'超連結',
    ...
    'wordOverFlowMsg':'<span style="color:red;">字數超出最大允許值，服務器可能拒絶保存！</span>',
    'ok':"確認",
    'cancel':"取消",
    'closeDialog':"關閉對話框",
    ...
    'insertimage':{
        ...
        'updateStatusReady': '選擇_張圖片',
        'updateStatusConfirm': '已成功上傳_張照片，_張照片上傳失敗',
        'updateStatusFinish': '一共_張圖片，_張上傳成功 :)',
        'updateStatusError': '，_張上傳失敗。',
        'errorNotSupport': '編輯器不支持您的瀏覽器！如果你使用的是IE瀏覽器，請嘗試升級 flash 播放器。',
        'errorLoadConfig': '後端配置項沒有正常加載，上傳插件不能正常使用！',
        'errorExceedSize':'圖片文件大小超出上限',
        'errorFileType':'不允許非圖片格式文件上傳',
        'errorInterrupt':'圖片文件傳輸中斷',
        'errorUploadRetry':'上傳失敗，請重試',
        'errorHttp':'HTTP請求錯誤',
        'errorServerUpload':'服務器返回出錯，請重試',
        'remoteLockError':"寬高不正確,不能所定比例",
        'numError':"請輸入正確的長度或者寬度值！例如：123，400",
        'imageUrlError':"不允許的圖片格式！",
    ...
    'help':{
        'static':{
            ...
            'lang_Txt_visualEnter':'軟確認',
            'lang_Txt_fullscreen':'全屏幕'
        }
    },
    'insertframe':{
        'static':{
    ...
    'link':{
        'static':{
            'lang_input_text':'顯示內容：',
            'lang_input_url':'連結URL位置：',
            'lang_input_title':'標題：',
            'lang_input_target':'是否在瀏覽器新視窗打開：'
        },
        'validLink':'只支持選中一個連結時生效',
        'httpPrompt':'您輸入的超連結中不包含http等協議名稱，默認將為您添加http://'
    },
    'map':{
        'static':{
            lang_city:"城市",
